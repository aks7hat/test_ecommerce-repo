package com.auth.Authentication.Service.config;
...
import com.auth.Authentication.Service.exceptions.RESTAuthenticationEntryPoint;
import com.auth.Authentication.Service.service.OAuthAuthenticationSuccessHandler;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .requestMatchers(HttpMethod.POST, "/api/products/indexAll").permitAll()
