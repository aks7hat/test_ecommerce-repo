  ...
  return (
    <>
      <div className="p-8">
        ...
        {userInfo?.email && (
          // <>
          //   <p className="text-xl font-bold">Hello {userInfo?.firstName ? userInfo?.firstName : userInfo?.email.split('@')[0]}</p>
          ...
          // </>
          <>
            <div className="bg-white shadow rounded-lg p-6" style={{border: '1px solid'}}>
              <div className="text-center mb-6">
                <h1 className="text-2xl font-bold">
                  Hello, {userInfo?.firstName?.toUpperCase() || userInfo?.email.split("@")[0]?.toUpperCase()}
                </h1>
              ...
              <div className="border-b border-gray-200">
                <nav className="flex space-x-4" aria-label="Tabs" style={{justifyContent:"center"}}>
                  <NavLink
                    to="/account-details/profile"
                    className={({ isActive }) =>
                      isActive
                        ? "px-4 py-2 text-md font-medium text-white bg-black rounded-t-lg"
                        : "px-4 py-2 text-md font-medium text-gray-600 hover:text-black hover:bg-gray-100 rounded-t-lg"
                    }
                  >
                    <svg className="w-4 h-4 me-2 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20" style={{marginLeft:'16px'}}>
                      <path d="M10 0a10 10 0 1 0 10 10A10.011 10.011 0 0 0 10 0Zm0 5a3 3 0 1 1 0 6 3 3 0 0 1 0-6Zm0 13a8.949 8.949 0 0 1-4.951-1.488A3.987 3.987 0 0 1 9 13h2a3.987 3.987 0 0 1 3.951 3.512A8.949 8.949 0 0 1 10 18Z" />
                    </svg>
                    Profile
                  </NavLink>
